...
class ProjectForm(forms.ModelForm):
    class Meta:
        model   = Project
        fields  = ('title', 'description', 'link', 'is_startup', 'needs_team', 'funding_goal', 'required_resources', 'video_url', 'image')
        widgets = {
            ...
            'video_url':   forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'YouTube/Vimeo havola'}),
            'funding_goal': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Masalan: 20000000 so\'m'}),
